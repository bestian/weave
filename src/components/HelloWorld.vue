    ...
    async drawL (k, bk) {
      ...
      if (!bk) {
        ...
        while (t < window.innerHeight) {
          ...
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(delta + k + 7, t)
          this.ctx.lineTo(delta + k + 7, t + 10)
          this.ctx.stroke()
          this.ctx.beginPath()
          ...
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(delta + k + 13, t)
          this.ctx.lineTo(delta + k + 13, t + 10)
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(getRandomInt(0, 5) + delta + k + 20, getRandomInt(0, 5) + t)
          this.ctx.lineTo(getRandomInt(0, 5) + delta + k + 20, getRandomInt(0, 5) + t + 10)
        ...
        while (t > 0) {
          ...
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(getRandomInt(0, 2) + delta + k + 7, getRandomInt(0, 2) + t)
          this.ctx.lineTo(getRandomInt(0, 2) + delta + k + 7, getRandomInt(0, 2) + t + 10)
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(delta + k + 20, t)
          this.ctx.lineTo(delta + k + 20, t + 10)
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(getRandomInt(0, 2) + delta + k + 13, getRandomInt(0, 2) + t)
          this.ctx.lineTo(getRandomInt(0, 2) + delta + k + 13, getRandomInt(0, 2) + t + 10)
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(delta + k + 20, t)
          this.ctx.lineTo(delta + k + 20, t + 10)
