    ...
    async drawL (k, bk) {
      ...
      if (!bk) {
        ...
        while (t < window.innerHeight) {
          ...
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(delta + k + 10, t)
          this.ctx.lineTo(delta + k + 10, t + 10)
          this.ctx.stroke()
          this.ctx.beginPath()
        ...
        while (t > 0) {
          ...
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(getRandomInt(0, 2) + delta + k + 10, getRandomInt(0, 2) + t)
          this.ctx.lineTo(getRandomInt(0, 2) + delta + k + 10, getRandomInt(0, 2) + t + 10)
          this.ctx.stroke()
          this.ctx.beginPath()
          this.ctx.moveTo(delta + k + 20, t)
          this.ctx.lineTo(delta + k + 20, t + 10)
